/**
 * 8. RideCo Ops Login — interact() with a named profile so the browser
 *    session (cookies, local storage) persists across runs.
 *
 *   Setup: put RIDECO_OPS_URL, RIDECO_OPS_USERNAME, RIDECO_OPS_PASSWORD,
 *   FIRECRAWL_API_KEY, OPENAI_API_KEY in .env.
 *
 *   Run:
 *     node --env-file=.env --import tsx examples/8-rideco-ops-login.ts
 */
...
const PROFILE_NAME = "rideco-ops-session";
const URL =
  process.env.RIDECO_OPS_URL || "https://ops.valleymetroconnect.rideco.com";
