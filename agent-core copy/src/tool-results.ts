...
export function parseToolResult({
  ...
  switch (toolName) {
    ...
    case "map":
      ...
      break;
    case "parse":
      // /parse returns the same { markdown, metadata, json } shape as scrape,
      // so reuse the scrape normalizer to get a rendered-markdown tile.
      payload = parseScrape("scrape", inputObj, normalizedOutput);
      break;
    case "scrapeBash":
    case "scrape_bash":
