      ...
      <div className="p-6 md:p-8">
        <div className="mb-8 space-y-3">
          ...
          <h2 className="text-2xl font-semibold text-white">
            Who the model gets wrong
          </h2>
          <p className="text-base leading-relaxed text-white/55">
            Sorted by Brier score. Lower means the probs were closer to the
            outcomes.
          </p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[560px] text-left text-base">
            <thead>
              <tr className="border-b border-white/10 text-sm font-medium text-white/50">
                <Th onClick={() => toggle("team_name")}>Team</Th>
                <Th onClick={() => toggle("total_games")}>G</Th>
                <Th onClick={() => toggle("prediction_accuracy")}>Acc</Th>
                <Th onClick={() => toggle("brier_score")}>Brier</Th>
                <Th onClick={() => toggle("bias_magnitude")}>Bias</Th>
              </tr>
            </thead>
            <tbody>
              {sorted.map((t, i) => (
                ...
                >
                  ...
                  <td className="py-4 pr-4 font-mono text-white/55">
                    {t.total_games}
                  </td>
